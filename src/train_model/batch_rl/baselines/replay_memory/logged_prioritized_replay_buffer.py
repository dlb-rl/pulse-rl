...
class OutOfGraphLoggedPrioritizedReplayBuffer(
    ...
    def __init__(self, log_dir, *args, **kwargs):
        ...
        super(OutOfGraphLoggedPrioritizedReplayBuffer, self).__init__(*args, **kwargs)
        self._log_count = 0
    ...
    def load(self, checkpoint_dir, suffix, log_count):
        super(OutOfGraphLoggedPrioritizedReplayBuffer, self).load(
            checkpoint_dir, suffix
        )
        self._log_count = log_count  # self.add_count // self._replay_capacity
...
class WrappedLoggedPrioritizedReplayBuffer(circular_replay_buffer.WrappedReplayBuffer):
